...
def smoke_generators() -> None:
    print("generator smoke skipped: email skill has no generate_*.py entry points")
...
def smoke_catalog_renderers() -> None:
    ...
    if not scripts_dir.exists():
        ...
        return
    renderer = scripts_dir / "render_email.py"
    if not renderer.exists():
        raise RuntimeError("scripts/render_email.py is required")
